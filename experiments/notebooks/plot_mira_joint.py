"""Joint (κ, θ) Mira score on the posterior samples written by
tarp_conditional.py — analog of plot_pokie_joint.py.

Loads (cosmo, field) per-job samples into one GPU tensor of shape
(1, T, S, q_cosmo + q_field), then calls
:func:`mira_score.mira_bootstrap_efficient`.
"""
...
def main():
    ...
    parser.add_argument("--output", default="tarp_results/mira_joint.pdf")
    ...
    parser.add_argument("--save-npz",
                        default="tarp_results/mira_joint_scores.npz")
