...
def main():
    ...
    parser.add_argument("--output", default=None,
                        help="Defaults to tarp_<space>.pdf in the results dir.")
    ...
    parser.add_argument("--metric", default="euclidean",
                        help="--space cosmo only.")
    # joint only
    parser.add_argument("--scalar-norm", action="store_true",
                        help="--space joint only: global [0,1] rescale instead "
                             "of per-dim. Mutually exclusive with --norm.")
    parser.add_argument("--max-samples", type=int, default=None,
                        help="--space joint only.")
