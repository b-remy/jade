...
This repository contains the official implementation of the paper [Joint inference of weak lensing convergence map and cosmology with diffusion models](https://arxiv.org/abs/2606.31988) by [Benjamin Remy](https://github.com/b-remy), Chihway Chang and Rebecca Willett.
